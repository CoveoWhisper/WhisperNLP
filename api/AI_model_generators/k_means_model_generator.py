...
#*************************************************save model
file_name = '../AI_models/tf_idf_matrix.bin'
binFile = open(file_name, 'wb')
binModel = pickle.dump(tf_idf_matrix, binFile)
binFile.close()
...
file_name = '../AI_models/clustering_model.bin'
binFile = open(file_name, 'wb')
binModel = pickle.dump(clustering_model, binFile)
binFile.close()

file_name = '../AI_models/clustering_model_result.bin'
binFile = open(file_name, 'wb')
